...
def red_noise_block(psd='powerlaw', prior='log-uniform', Tspan=None,
    ...
    if psd == 'null_powerlaw':
        ...
        pl = gpp.null_powerlaw(log10_r = log10_r, n_t = n_t, log10_T_rh = log10_T_rh, log10_f_inf = log10_f_inf)
...
def common_red_noise_block(psd='powerlaw', prior='log-uniform',
                           Tspan=None, components=30, combine=True, Phenom_constraint=None,
